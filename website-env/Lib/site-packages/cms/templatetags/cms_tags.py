...
class RenderPluginBlock(InclusionTag):
    """
    Acts like the CMS's templatetags 'render_model_block' but with a plugin
...
class CMSEditableObjectIcon(CMSEditableObject):
    ...
    The output of this templatetags is just an icon to trigger the changeform.
    """
...
class RenderUncachedPlaceholder(RenderPlaceholder):
    ...
    This templatetags will neither get the result from cache, nor will update
